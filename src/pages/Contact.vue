                  ...
                  <v-card-text>
                    ...
                    >
                      ...
                      <v-text-field
                        ...
                        clearable
                        required
                        class="mb-1 form highlight--text"
                      ></v-text-field>
                      <v-text-field
                        type="email"
                        name="email"
                        ...
                        clearable
                        required
                        class="my-1 form highlight--text"
                      ></v-text-field>
                      ...
                      <div class="text-center">
                        <v-btn
                          ...
                          clearable
                          type="submit"
                          class="highlight white--text px-10"
                        >Submit</v-btn>
                      </div>
                    </form>
                  </v-card-text>
            ...
            <v-col cols="12" md="6" lg="5">
              <div class="my-12">
                  ...
                  <a href="mailto:contact@vowaidfoundation.org">
                    <v-row justify="center" class="pb-6">
                      <v-col cols="3" class="text-center">
                        <v-icon size="45px" class="highlight--text">fas fa-envelope</v-icon>
                      </v-col>
                      <v-col cols="9">
                        <h4 class="secondary--text display-1">Send an email</h4>
                        <p class="secondary--text subtitle-1">contact@vowaidfoundation.org</p>
                      </v-col>
                    </v-row>
                  </a>
                </div>
                <div class="text-xs-left">
                  <a href="tel:781-486-3408">
                    <v-row justify="center" class="pb-6">
                      <v-col cols="3" class="text-center">
                        <v-icon size="45px" class="highlight--text">fas fa-mobile-alt</v-icon>
                      </v-col>
                      <v-col cols="9">
                        <h4 class="secondary--text display-1">Give us a ring</h4>
                        <p class="secondary--text subtitle-1">(781) 486-3408</p>
                      </v-col>
                    </v-row>
                  </a>
                </div>
                <div class="text-xs-left">
                  <v-row justify="center" class="pb-6">
                    <v-col cols="3" class="text-center">
                      <v-icon size="45px" class="highlight--text">fas fa-map-marked-alt</v-icon>
                    </v-col>
                    <v-col cols="9">
                      <h4 class="secondary--text display-1">
                        <span class="hide-on-mobile">Mailing</span> Address
                      </h4>
                      <p class="secondary--text subtitle-1">
                        2307 S. Rural Road
